...
final class Popped_Admin {
	...
	private static function advanced() {
		...
		/* translators: 1: First detected publication year. 2: Last detected publication year. */
		$range_help = sprintf( __( 'Automatic follows your published posts. Current detected range: %1$d–%2$d.', 'popped' ), $detected['start'], $detected['end'] );
		...
		self::select( 'year_range_mode', __( 'Year range', 'popped' ), $o['year_range_mode'], array( 'auto' => __( 'Automatic — Recommended', 'popped' ), 'manual' => __( 'Manual', 'popped' ) ), $range_help );
